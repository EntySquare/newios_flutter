...
class UpdateAddressDialog extends StatefulWidget {
  ...
  UpdateAddressDialog({this.addressBean, this.state, this.confirmCallBack})
      : super();

  @override
  _UpdateAddressDialogState createState() =>
      _UpdateAddressDialogState(addressBean, state, confirmCallBack);
}
...
// Step2.2: 焦点变化时的响应操作
  ...
  * state  0 表示第一个位置的，1表示第二个位置，2表示第三个位置*/
    ...
    showDialog(
        ...
        builder: (_) {
          return NetLoadingDialog2(
            ...
            loadingText: "修改中...",
            requestCallBack:
                this._netUpdateAdress(this._addressBean, loginBean),
          );
        }).then((_) {
  ...
  /*网络请求修改地址接口*/
  _netUpdateAdress(NetAddressBean netAddressBean, LoginBean loginBean) async {
    ...
    try {
      ...
      Toast.toast(context, msg: "修改失败,请检查网络链接");
      print(e);
    }
  }
}
